    ...
    public static boolean greaterThan(int[] arr) {
        ...
        for (int num = 0; num < arr.length; num++) {
            ...
            if (arr[num] % 2 == 1) {
                ...
                odds.add(arr[num]);
//                    System.out.println(arr[num] + " Added to Array value to Arraylist for Odds");

            }else if (arr[num] % 2 == 0) {
                if (arr[num] != evenmax) {
//                    System.out.println( arr[num] + "  Added to Array value to Arraylist for Even" );
                    evens.add(arr[num]);
...
//        for (int oddNum = 0; oddNum < odds.size(); oddNum++) {
//            for (int evenNum = 0; evenNum < evens.size(); evenNum++) {
       /**
        if (evens.isEmpty()){
            return true;
        } else {
...
//        }
            for (int oddNum = 0; oddNum < odds.size(); oddNum++) {
                    for (int evenNum = 0; evenNum < evens.size(); evenNum++ ) {
                        ...
                        if (odds.get(oddNum) > evens.get(evenNum)) {
                            isgreater = true;
                            System.out.println(odds.get(oddNum)+ " This odd is greater than the evens");
                            System.out.println(odds.get(oddNum)+ " This odd is less than the evens");
