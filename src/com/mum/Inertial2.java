    ...
    public class Inertial2 {
        ...
        public static void main(String[] args) {
            ...
            if (size <= 1) {
                ...
                int test = Inertial2.isInertial(value);
        ...
        private static int isInertial(int[] value) {
            ...
            int testOddValue = Inertial2.isOddValue(value);
            if (testOddValue == 1){
                testEvenMax = Inertial2.isEvenMax(value);
            } else {
                return 0;
            }
            if (testOddValue == 1 && testEvenMax == 1) {
                testOddGreater = Inertial2.isOddGreater(value);
            } else {
                return 0;
            }
        ...
        private static int isOddGreater(int[] value) {
            ...
            int maxEven = Inertial2.getMaxEven(value);
            for (int i = 0; i < len; i++) {
                if (value[i] % 2 == 0) {
                    if (value[i] != maxEven) {
                        even.add(value[i]);
